...
def main():
    ...
    try:
        ...
        # generator_train_data.mean = 0.456
        # generator_train_data.std = 0.225
        ...
        train_generator = generator_train_data.flow_from_directory(
            ...
            subset='training',
            seed=seed)
        # generator_val_data = ImageDataGenerator(rescale=1. / 255,
        #                                         featurewise_center=True,
        #                                         featurewise_std_normalization=True,
        #                                         validation_split=validation_split
        #                                         )
        # generator_val_data.mean = [0.456, 0.456, 0.456]
        # generator_val_data.std = [0.225, 0.225, 0.225]
        # val_generator = generator_val_data.flow_from_directory(
        #     image_generator_dir,
        ...
        callbacks = [
            ...
            csv_logger,
            # ReduceLROnPlateau(factor=factor_reduce_lr, patience=patience_reduce_lr, verbose=1, mode="min", min_lr=min_lr),
