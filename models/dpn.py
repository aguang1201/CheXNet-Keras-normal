...
def DPN92(input_shape=None,
    ...
    return DualPathNetwork(input_shape, include_top=include_top, weights=weights, input_tensor=input_tensor,
                           pooling=pooling, classes=classes, weights_path=weights_path)
...
def get_model(class_names, base_weights_path=None, weights_path=None, target_size=224, input_channel=3):
    """
    ...
    base_model = DPN92((target_size, target_size, input_channel), weights_path=base_weights_path, include_top=False)
