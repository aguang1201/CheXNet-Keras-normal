...
def get_model(weights_path=None, target_size=224):
    """
    ...
    senet = SEResNeXt(size=target_size)
    base_model = senet.model
...
class SEResNeXt(object):
    def __init__(self, size=96, num_classes=10, depth=64, reduction_ratio=16, num_split=8, num_block=3):
